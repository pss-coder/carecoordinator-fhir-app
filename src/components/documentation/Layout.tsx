...
import { Logo, Logomark } from '@/components/documentation/Logo'
...
import { ThemeSelector } from '@/components/documentation/ThemeSelector'
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link href="/documentation" aria-label="Documentation page">
          ...
          <Image
            ...
            width={30}
            height={30}
            alt="Picture of the shared care"
            />
        </Link>
      </div>
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  let isHomePage = pathname === '/documentation'
